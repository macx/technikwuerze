...
$replyTargetId = isset($reply_target_id) && trim((string)$reply_target_id) !== ''
...
<li class="<?= implode(' ', $classNames); ?>" id="c<?= $comment->id(); ?>">
    ...
    <?php else: ?>
        <footer>
            ...
            <a href="#kommentform" class="kommentReply" data-id="<?= $replyTargetId; ?>" data-handle="<?= $comment->authorName(); ?>"><?= t('mauricerenck.komments.action.reply.text'); ?></a>
        </footer>
    <?php endif; ?>
